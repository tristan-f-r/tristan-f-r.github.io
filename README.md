# [tristan-f-r.github.io](https://github.com/tristan-f-r/tristan-f-r.github.io)
...
- [awesome-minestom (68)](https://github.com/tristan-f-r/awesome-minestom) - A
  curated list of awesome Minestom libraries, resources, projects, and servers.
- [npm-rank (42)](https://github.com/tristan-f-r/npm-rank)
...
- [svelte-monaco (15)](https://github.com/tristan-f-r/svelte-monaco)
  ...
  integration
- [maxwell (12)](https://github.com/tristan-f-r/maxwell)
...
- [reed-board-track (0)](https://github.com/tristan-f-r/reed-board-track) - reed
...
- [stem-carnival-slots (0)](https://github.com/tristan-f-r/stem-carnival-slots)
...
- [bson-rust](https://github.com/tristan-f-r/bson-rust) - Encoding and decoding
...
- [hickory-dns](https://github.com/tristan-f-r/hickory-dns) - A Rust based DNS
...
- [rust-lightning](https://github.com/tristan-f-r/rust-lightning) - A highly
  ...
  Rusty's Lightning!
- [rust-socketio](https://github.com/tristan-f-r/rust-socketio) - An
...
- [voxel-rs](https://github.com/tristan-f-r/voxel-rs) - Rust Voxel engine
- [vscode-lean4](https://github.com/tristan-f-r/vscode-lean4) - Visual Studio
  Code extension for the Lean 4 proof assistant
- [vscode_deno](https://github.com/tristan-f-r/vscode_deno)
  ([homepage](https://marketplace.visualstudio.com/items?itemName=denoland.vscode-deno)) -
  Visual Studio Code plugin for Deno
- [wasm-pack](https://github.com/tristan-f-r/wasm-pack)
  ([homepage](https://rustwasm.github.io/wasm-pack/)) - 📦✨ your favorite rust
  -> wasm workflow tool!
- [wasm32-unknown-unknown-openbsd-libc](https://github.com/tristan-f-r/wasm32-unknown-unknown-openbsd-libc)
...
- [scannable-old-fork (4)](https://github.com/tristan-f-r/scannable-old-fork)
  ([homepage](https://leodog896.github.io/scannable)) - QR code generator for
  the web
- [awesome-surrealdb (2)](https://github.com/tristan-f-r/awesome-surrealdb) - A
  curated list of awesome SurrealDB resources, libraries, tools, and
  applications.
- [dite-deno (1)](https://github.com/tristan-f-r/dite-deno) - a little bit of a
  framework
- [svelte-tailwind-barebones (1)](https://github.com/tristan-f-r/svelte-tailwind-barebones) -
  Simple barebones tailwind template
- [big-type (0)](https://github.com/tristan-f-r/big-type) - big text, simple
  area.
- [CirCetz (0)](https://github.com/tristan-f-r/CirCetz) - typst+cetz circuit
  drawing library
- [dprint-plugin-python (0)](https://github.com/tristan-f-r/dprint-plugin-python) -
  Python formatter for dprint (ruff wrapper)
- [file_hash (0)](https://github.com/tristan-f-r/file_hash) - simple file
  registry in deno
- [lichess-board (0)](https://github.com/tristan-f-r/lichess-board) - deeply
  integrated lichess boad API in rust
- [minification-playground (0)](https://github.com/tristan-f-r/minification-playground) -
  a playground showcasing various JS minifiers for a blog post and for you
- [parcel-triage-mstile (0)](https://github.com/tristan-f-r/parcel-triage-mstile) -
  triage for mstile asset duplication in parcel
- [reversi-solver (0)](https://github.com/tristan-f-r/reversi-solver) - emulator
  & solver for reversi games
- [serpent-shuffle (0)](https://github.com/tristan-f-r/serpent-shuffle) - silly
  snake game
- [spin-2 (0)](https://github.com/tristan-f-r/spin-2)
